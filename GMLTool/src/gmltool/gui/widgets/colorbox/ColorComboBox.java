 ...
 */
package gmltool.gui.widgets.colorbox;
 ...
 * also pick a custom color using JColorChooser dialog. A "Random" entry can
 * also be selected.
 *
 * @author S. Aubrecht
...
public final class ColorComboBox extends JComboBox {
    ...
    /**
     * C'tor The combo box is initialized with some basic colors and user can
     * also pick a custom color and a random entry
     */
     ...
     *
     * @param newColor Color to be selected or null to clear selection. If the
     * color isn't in the combo box list and custom colors are not allowed the
